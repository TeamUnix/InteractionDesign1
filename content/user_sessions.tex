...
\begin{figure}[h!]
	\center
		...
		\fbox{\includegraphics[width=0.4\textwidth]{images/LF_hub.png}}
...
\begin{figure}[h!]
	\center
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{1pt}
		\fbox{\includegraphics[width=0.4\textwidth]{images/HF_hub.png}}
...
\begin{figure}[h!]
	\center
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{1pt}
		\fbox{\includegraphics[width=0.4\textwidth]{images/hub_start_of_partivipatory_design.png}}
...
\begin{figure}[h!]
	\center
		\setlength\fboxsep{0pt}
		\setlength\fboxrule{1pt}
		\fbox{\includegraphics[width=0.4\textwidth]{images/partivipatory_design.png}}
