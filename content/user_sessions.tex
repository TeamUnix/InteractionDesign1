...
All 'E-teachers' and the three web-costumers was invited to come by and witness a drama session, showing the data handling in the energy system. The session was made to clarify how the protocol in the system is going to work and find possible leaks in it. The session was divided into three scenes:
\begin{itemize}
	\item Scene 1
		\begin{enumerate}
...
\\[0.2cm]
As it can be seen on the video, the different modules in the system were played by persons from the EDE10 class
